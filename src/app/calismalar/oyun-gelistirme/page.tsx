...
import { ArrowLeft, ArrowUpRight, Gamepad2, MonitorPlay, Code2, Sparkles } from "lucide-react";
import Link from "next/link";
import { useLanguage } from "@/context/LanguageContext";

const TECHNOLOGIES = ["Unity", "C#", "Photon", "WebGL", "Blender", "Mobile & PC Architecture"];

export default function GameDevelopmentPage() {
    const { t } = useLanguage();
    const data = t.game_dev;

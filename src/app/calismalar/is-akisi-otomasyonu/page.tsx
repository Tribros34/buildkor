...
import { ArrowLeft, ArrowUpRight, Workflow, Zap, Database, Sparkles } from "lucide-react";
import Link from "next/link";
import { useLanguage } from "@/context/LanguageContext";

const TECHNOLOGIES = ["n8n", "FastAPI", "Python", "Node.js", "Redis", "PostgreSQL", "Docker"];

export default function WorkflowAutomationPage() {
    const { t } = useLanguage();
    const data = t.workflow_auto;
                    ...
                    <div className="lg:col-span-8">
                        <div className="rounded-2xl border border-border bg-surface p-2 overflow-hidden shadow-2xl">
                            <div className="relative aspect-video w-full overflow-hidden rounded-xl bg-black">
                                <video
                                    src="/videos/meshy_ai_video_3.mp4"
                                    autoPlay
                                    loop
                                    muted
                                    playsInline

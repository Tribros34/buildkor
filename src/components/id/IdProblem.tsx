        ...
        <section className="border-t border-white/5 py-24 md:py-32">
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="mt-14 grid gap-6 md:grid-cols-2 lg:gap-8">
                    {/* Klasik NFC kart */}
                    <Reveal>
                        <div className="h-full rounded-2xl border border-white/5 bg-white/[0.02] p-8 md:p-10">
                            ...
                            <ul className="mt-6 space-y-4">
                                {data.classic_points.map((p: string, i: number) => (
                                    <li key={i} className="flex items-start gap-3 text-muted">
                                        <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/[0.03]">
                                            <X className="h-3 w-3" />
                                        </span>
